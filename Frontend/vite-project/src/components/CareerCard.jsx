...
const CareerCard = (props) => {
  ...
  return (
    <div className={`rounded-[20px] bg-[${background}] p-[12px] gap-[20px] flex flex-col justify-center items-center`}>
                  ...
                  <div className={`w-full py-[12px] px-[28px] rounded-[12px] flex justify-center items-center bg-[${props.subColor}]`} >
